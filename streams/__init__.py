...
class DoublyLinkedStream(SinglyLinkedStream, Reversible):
    ...
    def __init__(
        ...
        :param previous_thunk is a zero-argument function that should
            return the preceding node. It defaults to behaving similarly
            to singly linked nodes.
    ...
    def _filter(self, predicate, traversal_direction):
        ...
        :param traversal_direction: the direction in which the nodes
            should be traversed
        """
    ...
    def _from_iterator(cls, iterator, previous_thunk=None, does_memoize=True):
        ...
        :param previous_thunk: a zero-argument function that should
            return the preceding node. It defaults to behaving similarly
            to singly linked nodes.
...
def thunk_init(thunk, init):
    ...
    :param thunk: the zero-parameter function that returns the object of
    interest
